...
import { 
    ...
    Save, Key, Sparkles, CreditCard, Users, Trash2, Plus, 
            ...
            <div className="grid md:grid-cols-4 gap-10">
                ...
                <div className="md:col-span-1 space-y-2">
                    ...
                    <div className="pt-4 mt-4 border-t border-gray-100 flex flex-col gap-2">
                         <SidebarLink active={activeTab === 'api'} icon={<Key size={18} />} label="API & Ledger" onClick={() => setActiveTab('api')} />
                                                    ...
                                                    <tr key={member.id} className="group">
                                                        ...
                                                        <td className="py-4">
                                                            <span className={`px-2 py-0.5 rounded-md text-[10px] font-black uppercase tracking-tighter ${
                                                                member.role === 'ADMIN' ? 'bg-amber-50 text-amber-600' : 'bg-blue-50 text-blue-600'
                                                            }`}>
                                                                {member.role}
                                                            </span>
                                                        </td>
                                ...
                                <div className="space-y-8">
                                        ...
                                        <div className="relative z-10 space-y-6">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <h2 className="text-4xl font-black tracking-tight">{stats?.subscription?.plan_name || 'BASIC TRIAL'}</h2>
                                                </div>
                                            ...
                                            <div className="pt-2 flex flex-col md:flex-row gap-6 items-center">
                                                <button className="w-full md:w-auto px-10 py-4 bg-brand-500 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-brand-400 transition shadow-lg shadow-brand-500/20">
                                                    Upgrade Plan
                                                </button>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <PricingCard 
                                            ...
                                            limit={stats?.subscription?.plan_name === 'ENTERPRISE' ? 'UNLIMITED' : '1,000'}
                                        />
                                        <PricingCard 
                                            label="Verifications" 
                            ...
                            {activeTab === 'api' && (
                                <div className="flex flex-col items-center justify-center h-full text-center space-y-4 py-20">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500 font-medium font-mono text-sm uppercase tracking-tighter">Scheduled for Phase 3: Infrastructure Expansion</p>
                                    </div>
                                </div>
                            )}
                        </motion.div>
